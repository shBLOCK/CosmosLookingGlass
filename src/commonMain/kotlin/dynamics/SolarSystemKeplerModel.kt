...
private const val BC3000 = -50L * AstroTime.SECONDS_IN_CENTURY
private const val AD3000 = 10L * AstroTime.SECONDS_IN_CENTURY
...
class SolarSystemKeplerModel3000BC3000AD : SolarSystemKeplerModelBase() {
    ...
    +                                     -0.00002864.au,  0.00018026, -0.00322699.deg.rad,   3034.90371757.deg.rad,   0.18199196.deg.rad,   0.13024619.deg.rad, -0.00012452,  0.06064060, -0.35635438, 38.35125000, timeMin = BC3000, timeMax = AD3000)
    ...
    +                                     -0.00003065.au, -0.00032044,  0.00451969.deg.rad,   1222.11494724.deg.rad,   0.54179478.deg.rad,  -0.25015002.deg.rad,  0.00025899, -0.13434469,  0.87320147, 38.35125000, timeMin = BC3000, timeMax = AD3000)
    ...
    +                                     -0.00020455.au, -0.00001550, -0.00180155.deg.rad,    428.49512595.deg.rad,   0.09266985.deg.rad,   0.05739699.deg.rad,  0.00058331, -0.97731848,  0.17689245,  7.67025000, timeMin = BC3000, timeMax = AD3000)
    ...
    +                                      0.00006447.au,  0.00000818,  0.00022400.deg.rad,    218.46515314.deg.rad,   0.01009938.deg.rad,  -0.00606302.deg.rad, -0.00041348,  0.68346318, -0.10162547,  7.67025000, timeMin = BC3000, timeMax = AD3000)
    //@formatter:on
